...
<asp:Content ID="aboutContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="about">
         ...
         <p>Enter <a href="http://www.nerdRide.com">NerdRide.com</a>, for all your event planning needs. We're focused on one thing. Organizing the world's
         nerds and helping them ride together. </p>
         ...
         involved in the Nerd Ride movement. Well, it's not really a movement. Mostly just geeks riding together, but still.</p>
	</div>
</asp:Content>
