...
document.write('<script>var link = document.createElement(\"link\");link.href = \"http://nerdride.cloudapp.net/content/Flair.css\";link.rel = \"stylesheet\";link.type = \"text/css\";var head = document.getElementsByTagName(\"head\")[0];head.appendChild(link);</script>');
document.write('<div id=\"nd-wrapper\"><h2 id=\"nd-header\">nerdride.cloudapp.net</h2><div id=\"nd-outer\">');
<% if (Model.Rides.Count == 0) { %>
    document.write('<div id=\"nd-bummer\">Looks like there\'s no Nerd Rides near <%:Model.LocationName %> in the near future. Why not <a target=\"_blank\" href=\"http://www.nerdride.cloudapp.net/Rides/Create\">host one</a>?</div>');
<% } else { %>
