<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Mobile/Site.Master" Inherits="System.Web.Mvc.ViewPage<NerdRide.Models.Ride>" %>

<asp:Content ContentPlaceHolderID="TitleContent" runat="server"><%: Model.Title %></asp:Content>

<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <h1><a href="/" runat="server"><img alt="nerdRide" src="Content/Img/Mobile/logo_medium.jpg"/></a></h1>
    <h2><%: Model.Title %></h2>
    <ul id="Details">
