...
set _DeploySetParametersFile=%RootPath%webAppMVCIndexer3.SetParameters.xml
)
...
:usage
echo =========================================================
if not exist "%RootPath%webAppMVCIndexer3.deploy-readme.txt" (
...
start notepad "%RootPath%webAppMVCIndexer3.deploy-readme.txt"
)
echo =========================================================
goto :eof
