...
namespace BookIndexing
{
    public class Indexer
    {
        public string Process(string input)
        {
            ...
            var engine = new BookIndexing.WordNetEngine(fi.DirectoryName, true);

            var indexer = new SalientWords(skipList, engine);
        ...
        {
            protected WordNetEngine engine { get; set; }
        ...
        {
            public SalientWords(SkipList<WordInfo> skipList, WordNetEngine engine)
            {
                base.engine = engine;
